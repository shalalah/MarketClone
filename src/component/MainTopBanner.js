      ...
      >
        <div className="swiper-wrapper">
          <SwiperSlide className="swiper-slide">
            <img class="banner_image" src={Slide1} alt="Slide 1" />
          </SwiperSlide>
          <SwiperSlide className="swiper-slide">
            <img class="banner_image" src={Slide2} alt="Slide 2" />
          </SwiperSlide>
          <SwiperSlide className="swiper-slide">
            <img class="banner_image" src={Slide3} alt="Slide 3" />
          </SwiperSlide>
          <SwiperSlide className="swiper-slide">
            <img class="banner_image" src={Slide4} alt="Slide 4" />
          </SwiperSlide>
          <SwiperSlide className="swiper-slide">
            <img class="banner_image" src={Slide5} alt="Slide 5" />
          </SwiperSlide>
          <SwiperSlide className="swiper-slide">
            <img class="banner_image" src={Slide6} alt="Slide 6" />
          </SwiperSlide>
        </div>
      </Swiper>
    </div>
